...
public class ExplicitRm3Reranker<T> implements Reranker<T> {
	private static final Logger LOG = LogManager.getLogger(ExplicitRm3Reranker.class);

	private final Analyzer analyzer;
	private final String field;
	private final QueryExpansionConfiguration config;

	public ExplicitRm3Reranker(Analyzer analyzer, QueryExpansionConfiguration config) {
    ...
    try {
      ...
      return feedbackQuery(relevanceFeedback, context);	
    } catch (IOException e) {
